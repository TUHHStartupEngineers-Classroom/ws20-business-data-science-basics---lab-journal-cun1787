...
#Since state and city are multiple features (variables), 
#they should be split. Which state has the highes revenue? 
#Replace your bike_orderlines_wrangled_tbl object 
#with the newly wrangled object (with the columns state and city).
#8.1.1 new object using seperate
bike_orderlines_wrangled_split_location_tbl <-bike_orderlines_wrangled_tbl %>%
  separate(col = location,
           into = c("city", "state"),
           sep = ", ")
#8.1.2 prepare to visualize
revenue_by_state_and_Year_tbl <-bike_orderlines_wrangled_split_location_tbl%>%
  ...
  mutate(sales_text = scales::dollar(sales, big.mark = ".", 
                                     ...
                                     prefix = "", 
                                     suffix = " €"))
revenue_by_state_tbl <-bike_orderlines_wrangled_split_location_tbl%>%
...
revenue_by_state_tbl %>%
  ...
  labs(
    ...
    subtitle = "Bremen has the most"
  )
#8.2 Plot
revenue_by_state_and_Year_tbl %>%
